...
bool initEEPROM() {
  ...
  if (c1 != 68 || c2 != 85) { // RU 68 85
    ...
    #ifdef ESP8266
    EEPROM.write(EEPROM_START_C1, 68);
    EEPROM.write(EEPROM_START_C2, 85);
    EEPROM.write(EEPROM_LEVEL_NO, 255);
    EEPROM.commit();
    #else
...
void saveGame() {
  ...
  #ifdef ESP8266
  EEPROM.write(EEPROM_LEVEL_NO, level);
  EEPROM.write(EEPROM_PLAYER_LEVEL, playerLevel);
  #else
